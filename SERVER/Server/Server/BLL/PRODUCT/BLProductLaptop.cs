...
{
    class BLProductLaptop
    {
        DBConnectDatabase db = null;
        public BLProductLaptop()
        {
        ...
        {
            return db.ExecuteQueryDataSet("select * from LAPTOP", CommandType.Text);
        }
        ...
        {
            //Inert image
            string sqlStringImg = "Insert Into HINHANH_LAPTOP(IdImage, Image1, Image2, Image3, Image4) VALUES (@id,@img1,@img2,@img3,@img4)";
            ...
            string sqlString = "Insert Into LAPTOP Values(" + "N'" + maSP + "',N'" + tenSP + "',N'" + thuongHieu + "','" + loai
        ...
        public bool Update(string maSP, string tenSP, string thuongHieu, string loai,
                            ...
                            byte[] image1, byte[] image2, byte[] image3, byte[] image4, DateTime ngayThem, ref string err)
        {
            string sqlStringImg = "UPDATE HINHANH_LAPTOP SET Image1=@img1,Image2=@img2,Image3=@img3,Image4=@img4 WHERE IdImage = @id";
            ...
            if (!db.MyExecuteNonQuery(sqlStringImg, CommandType.Text, ref err))
                return false;
            string sqlString = "Update LAPTOP Set TenSP = N'" + tenSP + "',ThuongHieu = N'" + thuongHieu + "',Loai = N'" + loai +
        ...
        {
            string sqlString = "Delete From LAPTOP Where MaSP='" + maSP + "'";

            string sqlStringImg = "Delete From HINHANH_LAPTOP Where IdImage='" + idImage + "'";
