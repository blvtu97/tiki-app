...
{
    class BLProductFashion
    {
        DBConnectDatabase db = null;
        public BLProductFashion()
        {
        ...
        {
            //Inert image
            string sqlStringImg = "Insert Into HINHANH_THOITRANG(IdImage, Image1, Image2, Image3, Image4) VALUES (@id,@img1,@img2,@img3,@img4)";
            ...
            string sqlString = "Insert Into THOITRANG Values(" + "N'" + maSP + "',N'" + tenSP + "',N'" + thuongHieu + "','" + loai
        ...
        public bool Update(string maSP, string tenSP, string thuongHieu, string loai,
                            ...
                            byte[] image1, byte[] image2, byte[] image3, byte[] image4, DateTime ngayThem, ref string err)
        {
            string sqlStringImg = "UPDATE HINHANH_THOITRANG SET Image1=@img1,Image2=@img2,Image3=@img3,Image4=@img4 WHERE IdImage = @id";
            ...
            if (!db.MyExecuteNonQuery(sqlStringImg, CommandType.Text, ref err))
                return false;
            string sqlString = "Update THOITRANG Set TenSP = N'" + tenSP + "',ThuongHieu = N'" + thuongHieu + "',Loai = N'" + loai +
        ...
        {
            string sqlString = "Delete From THOITRANG Where MaSP='" + maSP + "'";

            string sqlStringImg = "Delete From HINHANH_THOITRANG Where IdImage='" + idImage + "'";
